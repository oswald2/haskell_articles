...
William Yao created a link collection (\href{https://williamyaoh.com/posts/2019-11-24-design-and-testing-articles.html}{see here}) of Haskell articles about design and testing. I did like this collection very much but wanted to have all of them in one document, with one formatting. So the idea of this document (which is now more like a book) was born. 
