...
{\sffamily
\noindent This document is a compilation of web articles about Haskell, which was put together by William Yaoh. I was interested to have this in one document and not spread via different web pages, so I compiled them together in this document. 
...
\chapter{Introduction by William Yaoh}
...
\chapter{Posts on designing and structuring code}
