...
\section{``There and back again''}\label{there-and-back-again2}
...
verify''}\label{hard-to-prove-easy-to-verify2}
...
change''}\label{some-things-never-change2}
...
problem''}\label{solving-a-smaller-problem2}
...
same''}\label{the-more-things-change-the-more-they-stay-the-same2}
...
one''}\label{two-heads-are-better-than-one2}
...
\section{``Model-based'' testing}\label{model-based-testing2}
